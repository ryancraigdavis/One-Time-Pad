    ...
    while (strstr(buffer, "@@") == NULL){
      ...
      if (beginning_read == true) {
        ...
        if (cmp_enc != 0) {
          ...
          // If the first few chars aren't DEC, send an error message back to the
    ...
    if (connect_bool == true) {
      ...
      *terminal_buff = '\0';
      ...
      if(childPid == 0){
        ...
        write(pipeProc[1], plain_text, input_length+2); 
